import keras
from keras.layers import Conv1D, BatchNormalization, Activation, MaxPooling1D, GlobalAveragePooling1D, Input, Dense
from one_d import dense_block, transition_block
...
#         output = Dense(num_outputs, activation="softmax")(output)
        output = Dense(num_outputs, activation=None)(output)
